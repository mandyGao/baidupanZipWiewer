...
public class DBHelper extends SQLiteOpenHelper {
	...
	private static final String DATABASE_NAME = "ddddddd.db";
	...
	public String checkPass(){
		...
		String result = "";
		Cursor cursor = db.query(TABLE_USERINFO, new String[] {"pass"}, "_id=?", new String[] {"1"}, null, null, null);
	...
	public String queryForData() {
		SQLiteDatabase db = getReadableDatabase();
		String result = "";
		Cursor cursor = db.query(TABLE_DATA, new String[] {"jsonstr"}, "_id=?", new String[] {"1"}, null, null, null);
	    if (cursor.moveToFirst()){
	    	result = cursor.getString(0);
	    }
	    cursor.close();
